...
def update_outer_exp(conn: pymysql.connect, updated_id, teacher_id, location, title):
    cur = conn.cursor()
...
def update_inner_exp(conn: pymysql.connect, updated_id, teacher_id, location, title):
    cur = conn.cursor()
...
def update_talent(conn: pymysql.connect, updated_id, teacher_id, description):
    cur = conn.cursor()
...
def update_background(conn: pymysql.connect, updated_id, teacher_id, uni_name, major, degree):
    cur = conn.cursor()
...
def update_course(conn: pymysql.connect, updated_id, teacher_id, course_name, class_time, day_in_week):
    cur = conn.cursor()
...
def update_journal(conn: pymysql.connect, updated_id, teacher_id, name, colaborator, date, category):
    cur = conn.cursor()
...
def delete_outer_exp(conn: pymysql.connect, delete_id):
    cur = conn.cursor()
    
    cur.execute(f"DELETE FROM 校外經歷 WHERE 校外經歷id='{delete_id}';")
    conn.commit()
    
def delete_inner_exp(conn: pymysql.connect, delete_id):
    cur = conn.cursor()
    
    cur.execute(f"DELETE FROM 校內經歷 WHERE 校內經歷id='{delete_id}';")
    conn.commit()
    
def delete_talent(conn: pymysql.connect, delete_id):
    cur = conn.cursor()
    
    cur.execute(f"DELETE FROM 專長 WHERE 專長id='{delete_id}';")
    conn.commit()
    
def delete_background(conn: pymysql.connect, delete_id):
    cur = conn.cursor()
    
    cur.execute(f"DELETE FROM 學歷 WHERE 學歷id='{delete_id}';")
    conn.commit()
    
def delete_course(conn: pymysql.connect, delete_id):
    cur = conn.cursor()
    
    cur.execute(f"DELETE FROM 課表 WHERE 課程id='{delete_id}';")
    conn.commit()
    
def delete_journal(conn: pymysql.connect, delete_id):
    cur = conn.cursor()
    
    cur.execute(f"DELETE FROM 論文 WHERE 論文id='{delete_id}';")
    conn.commit()
    
def read_outer_exp_data(conn: pymysql.connect):
    cur = conn.cursor()
...
def read_inner_exp_data(conn: pymysql.connect):
    cur = conn.cursor()
...
def read_talent_data(conn: pymysql.connect):
    cur = conn.cursor()
...
def read_course_table_data(conn: pymysql.connect):
    cur = conn.cursor()
...
def read_learning_background_data(conn: pymysql.connect):
    cur = conn.cursor()
...
def read_journal_data(conn: pymysql.connect):
    cur = conn.cursor()
...
def create_outer_exp(conn: pymysql.connect, outer_exp_id, teacher_id, location, title):
    cur = conn.cursor()
...
def create_inner_exp(conn: pymysql.connect, inner_exp_id, teacher_id, location, title):
    cur = conn.cursor()
...
def create_learning_background(conn: pymysql.connect, degree_id, teacher_id, uni_name, major, degree):
    cur = conn.cursor()
...
def create_talent(conn: pymysql.connect, talent_id, teacher_id, talent_description):
    cur = conn.cursor()
    query = f"""
    INSERT INTO 專長
...
def create_teacher(conn: pymysql.connect, teacher_id, teacher_name):
    cur = conn.cursor()
    query = f"""
    INSERT INTO 老師
...
def create_courses(conn: pymysql.connect, course_id, teacher_id, course_name, class_time, day_in_week):
    cur = conn.cursor()
...
def create_journal(conn: pymysql.connect, journal_id, teacher_id, name, collaborator, date, category):
    cur = conn.cursor()
...
def create_table_if_not_exist(conn: pymysql.connect):
...
def connect():
    ...
    try:
        # Connect to server
        connect_db = pymysql.connect(**dbsettings)
